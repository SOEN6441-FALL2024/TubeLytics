...
public class HomeController extends Controller {
    ...
    /**
     * Displays the channel profile with all available profile information
    ...
    public CompletionStage<Result> channelProfile(String channelId) {
        return youTubeService.getChannelInfoAsync(channelId)
                .thenCombine(youTubeService.getLast10VideosAsync(channelId), (channelInfo, videos) -> {
                    if (channelInfo == null) {
    ...
    public CompletionStage<Result> fetchLatestVideos(String channelId) {
        return youTubeService.getLast10VideosAsync(channelId)
                .thenApply(videos -> {
                    if (videos.isEmpty()) {
