...
public class MessagesTest {
    ...
    public void testSearchResultsMessageEquality() {
        ...
        videos1.add(new Video("Title1", "Description1", "ChannelId1", "VideoId1", "ThumbnailUrl1", "ChannelTitle1", "2024-11-06T04:41:46Z"));

        List<Video> videos2 = new ArrayList<>();
        videos2.add(new Video("Title1", "Description1", "ChannelId1", "VideoId1", "ThumbnailUrl1", "ChannelTitle1", "2024-11-06T04:41:46Z"));

        List<Video> videos3 = new ArrayList<>();
        videos3.add(new Video("Title2", "Description2", "ChannelId2", "VideoId2", "ThumbnailUrl2", "ChannelTitle2", "2024-11-06T04:41:46Z"));
        ...
        assertFalse("Message should not be equal to an object of a different type.", msg1.equals("Not a SearchResultsMessage"));
    }
    ...
    public void testEqualityAndHashCode() {
        List<Video> videos1 = new ArrayList<>();
        videos1.add(new Video("Title1", "Description1", "Channel1", "VideoId1", "ThumbnailUrl1", "channelTitle1", "2024-11-06T04:41:46Z"));

        List<Video> videos2 = new ArrayList<>();
        videos2.add(new Video("Title1", "Description1", "Channel1", "VideoId1", "ThumbnailUrl1", "channelTitle1", "2024-11-06T04:41:46Z"));
    ...
    public void testToString() {
        List<Video> videos = new ArrayList<>();
        videos.add(new Video("Title", "Description", "Channel", "VideoId", "ThumbnailUrl", "channelTitle", "2024-11-06T04:41:46Z"));

        Messages.SearchResultsMessage message = new Messages.SearchResultsMessage("query", videos);

        String expectedString = "SearchResultsMessage{searchTerm='query', videos=" + videos.toString() + "}";
    ...
    public void testLargeSearchResultsMessage() {
        ...
        Messages.SearchResultsMessage message = new Messages.SearchResultsMessage(query, largeVideoList);
    ...
    public void testErrorMessageConstructorAndGetter() {
        ...
        assertEquals("The message should match the provided text.", errorMessageText, errorMessage.getMessage());
    }
    @Test
    public void testErrorMessageEquals() {
        ...
        assertTrue("ErrorMessage objects with the same message should be equal.", errorMessage1.equals(errorMessage2));

        // Test inequality with different message content
        assertFalse("ErrorMessage objects with different messages should not be equal.", errorMessage1.equals(errorMessage3));
        ...
        assertFalse("ErrorMessage should not be equal to an object of a different type.", errorMessage1.equals("A string"));
    }
    ...
    public void testErrorMessageToString() {
        ...
        assertEquals("The string representation should match the expected format.", expectedString, errorMessage.toString());
    }
    ...
    public void testErrorMessageEqualityAndHashCode() {
        ...
        System.out.println("errorMessage1.equals(errorMessage2): " + errorMessage1.equals(errorMessage2));
        ...
        // Test equality
        assertEquals("ErrorMessage objects with the same message should be equal.", errorMessage1, errorMessage2);
        assertNotEquals("ErrorMessage objects with different messages should not be equal.", errorMessage1, errorMessage3);

        // Test hashCode consistency
        assertEquals("Hash codes should match for equal objects.", errorMessage1.hashCode(), errorMessage2.hashCode());
        assertNotEquals("Hash codes should differ for unequal objects.", errorMessage1.hashCode(), errorMessage3.hashCode());
    }
